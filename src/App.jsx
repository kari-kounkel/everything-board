...
const BINDER_TABS = [
  ...
  { id: "shows", num: "1", title: "Shows & Scripts", emoji: "🎭", color: "#C7366B" },
  { id: "books", num: "2", title: "Books & Chapters", emoji: "📚", color: "#9B2335" },
  { id: "guests", num: "3", title: "Guest & Group", emoji: "🤝", color: "#D4644E" },
  { id: "devotionals", num: "4", title: "Devotionals", emoji: "✝️", color: "#8B6D3F" },
  { id: "frameworks", num: "5", title: "Frameworks", emoji: "🧩", color: "#2D6A9F" },
  { id: "braindumps", num: "6", title: "Brain Dumps", emoji: "🧠", color: "#E07B39" },
  { id: "snortory", num: "7", title: "Snortory & Kids", emoji: "🐾", color: "#C7548E" },
  { id: "rewrite", num: "8", title: "Rewrite Carousel", emoji: "🎠", color: "#6B5B8A" },
  { id: "funnels", num: "9", title: "Funnels & Systems", emoji: "⚙️", color: "#3A7D7B" },
  { id: "business", num: "10", title: "Business & Income", emoji: "💰", color: "#5B8C5A" },
  { id: "clients", num: "11", title: "Clients & Services", emoji: "🤙", color: "#4A6FA5" },
  { id: "strategy", num: "12", title: "Strategy & Archives", emoji: "🗺️", color: "#7B6E8A" },
